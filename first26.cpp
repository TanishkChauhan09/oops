...
class InvalidAmountclass: public runtime_error
{
    public:
    InvalidAmountclass(const string &msg): runtime_error(msg){};
...
class Customer{
    ...
    void deposit(int amount){
        ...
        if(amount>0){
            ...
            throw InvalidAmountclass("Amount deposited should be greater than 0");  // throw is like return, iske aage ki koi bhi statement nhi chalti so iss code ko ek aur way se likh skta hai , ab bss throw condition phle check krlenege within the block and then fir apne logic ko baad me bina kisi condition ke likh skte hai
        }
    ...
    void withdraw(int amount){
        ...
        { 
           ...
           return;
            ...
            throw InvalidAmountclass("Debited amount should be greater than 0");
...
int main(){
    ...
    catch(const InvalidAmountclass &e){
