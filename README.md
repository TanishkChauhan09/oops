...
BUT,
   classes(user defined data type) is something that have the power to define the many reference of the space(class attributes and behaviour) as many as we want and using the 
   object(variable name) we can use the properties of the class so like the particular language provided us the way to use the data type and variable name we can also us the
